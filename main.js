...
function addtime() {
  ...
  let milli =
    milliseconds.toString().length <= 2
      ? `${format(milliseconds.toString().split('')[milliseconds.toString().length - 2])}`
      : `${milliseconds.toString().split('')[milliseconds.toString().length - 3]}${milliseconds.toString().split('')[milliseconds.toString().length - 2]}`;
  console.log(milli);
